       ...
       <!-- <nav id="navbarZezible" class="navbar navbar-expand-md navbar-light navbar-laravel" >-->
            <div class="container" >
                <a class="navbar-brand" href="{{ url('/home') }}">
                    <img src="asvale-blanco.svg" width="30" height="30" class="d-inline-block align-top" alt="">
                    Asociación anónima
                </a>
                <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="{{ __('Toggle navigation') }}">
                 ...
                 <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        @else
                            <li class="nav-item">
                                <a class="nav-link ja" href="{{ route('actividadesList')}}">Actividades disponibles</a>
                            </li>
                            <li>
                                <a class="nav-link ja" href="{{ route('Perfil') }}">Mi perfil</a>
                            </li>
                            <li>
                                <a class="nav-link ja" href="{{route('MisActividades')}}">Mis actividades apuntadas</a>
                            </li>
                            <li>
                                <a class="nav-link ja" href="{{route('MisActividadesCreadas')}}">Mis actividades creadas</a>
                            </li>
                            ...
                            <li>
                                <a class="nav-link ja" href="{{ route('crearActividadSimple')}}">Crear actividad</a>
                            </li>
                            <li>
                                <a class="nav-link ja" href="{{ route('logout') }}"
                                       onclick="event.preventDefault();
                                                     document.getElementById('logout-form').submit();">
                                        {{ __('Logout') }}
                                </a>
...
<footer class="page-footer font-small">
  ...
  <div class="footer-copyright text-center py-3">© 2019 Copyright:
    <a href="http://www.google.org/"> Asociación anónima</a>
  </div>
  <!-- Copyright -->
